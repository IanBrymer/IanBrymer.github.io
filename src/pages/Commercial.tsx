    ...
    return (
        <>
            ...
            <div className='pb-5 pt-3' style={{ margin: 'auto' }}>
                <Row className='w-100 '>
                    <Col style={{ padding: 0, display: 'block' }}>
                    ...
                    <Col style={{ alignItems: 'center', padding: 0, display: 'flex', paddingTop: '35px' }}>
                        <Nav.Link href='/commercial/migym' style={{ padding: 0, display: 'block', width: 'min-content', margin: 'auto' }}>
                            <Col style={{ padding: 0, display: 'block' }}>
                                <Card style={{ minWidth: '500px', maxWidth: '900px', height: 'min-content', borderRadius: '0 0 0 0' }}>
