        ...
        <>
            <div className="App">
                <div className='OtherPageheader'>
                    ...
                    <PageHeaders fontSize='2.5vw' scaleOne='1.5' scaleTwo='2.5' backgroundFontSize='9vw' height='45vh' backgroundHeader="EDUCATIONAL" header='EXPLORE A FEW OF OUR EDUCATIONAL BUILDS'></PageHeaders>
